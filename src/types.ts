...
// Note: The Env interface is auto-generated by `wrangler types` in worker-configuration.d.ts
// Do not manually define Env here - it drifts from actual bindings in wrangler.jsonc
// Run `npx wrangler types` after changing wrangler.jsonc to regenerate types

// Request handler types (uses global Env from worker-configuration.d.ts)
